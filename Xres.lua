...
TabPlayer:CreateToggle({Name = "Infinity Jump",CurrentValue = false,Flag = "InfinityJump",Callback=function(s) InfinityJumpEnabled(s) end})
LP.CharacterAdded:Connect(function() if EnableInfinityJump then task.wait(0.2) setDisableInfinityJump(true) end end)
